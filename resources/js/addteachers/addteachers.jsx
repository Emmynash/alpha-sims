...
const AddTeachers = () => {
    ...
    const confirmTeachersRegAsign = (e) => {
        console.log(e)
        setSystemNumber(e.systemid),
            setTeacherdetails(e)
    ...
    return (
        <div className="">
            ...
            <div>
                ...
                {/* modal for asigning subjects */}
                <div className="modal fade" id="asign-subject-more" data-backdrop="false">
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h4 className="modal-title">Assign Subject</h4>
                            ...
                            <div className="modal-body">
...

                                {
                                    allTeachersWithSubject.length > 0 ? allTeachersWithSubject.map(d => (
                                        ...
                                        <div key={d.id + "teachersub"} className="card">
