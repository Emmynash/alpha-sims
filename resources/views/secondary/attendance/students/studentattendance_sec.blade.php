...
@include('layouts.aside_sec')
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="card" style="border-top: 2px solid #0B887C;">
            ...
            <form id="fetchslass_sec" action="javascript:console.log('submitted');" method="POST">
                @csrf
                ...
                <div class="row" style="margin: 10px;">
                    <button type="button" id="fetchslass_secbtn" class="btn btn-info btn-sm">Query</button>
              ...
              <div class="card">
                ...
                <div class="card-body table-responsive p-0">
                  <table class="table table-hover text-nowrap">
                    ...
                    <tbody id="fetcheduserstableattendance">
                      <tr>
                        <td>NA</td>
                        <td>NA</td>
                        <td>NA</td>
  ...
  <script>
      function scrollocation(){
        ...
        document.getElementById('studentatt_sec_add').className = "nav-link active"
      }
