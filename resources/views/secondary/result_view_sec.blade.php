                    ...
                    success: function(result) {
                        ...
                        if (result.resultdetails) {
                            ...
                            for (let index = 0; index < result.resultdetails.length; index++) {
                                ...
                                html += "<tr style='font-size: 12px; width: 150px;'>" + "<td class='text-center thdesign'>" + element.subjectname + "</td>" + "<td class='text-center thdesign'>" + Math.round(element.ca3) + "</td>" + "<td class='text-center thdesign'>" + Math.round(element.ca1) + "</td>" + "<td class='text-center thdesign'>" + Math.round(element.ca2) + "</td>" + "<td class='text-center thdesign'>" + Math.round(element.exams) + "</td>" + "<td class='text-center thdesign'>" + Math.round(((element.totalmarks + Number.EPSILON) * 100) / 100) + "</td>" + "<td class='text-center thdesign'>" + Math.round(((element.average + Number.EPSILON) * 100) / 100) + "</td>" + "<td class='text-center thdesign'>" + element.position + "</td>" + "<td class='text-center thdesign'>" + element.grades + "</td>" + "<tr>"
            ...
            <div style="width: 793px; height: 1123px; border: 2px solid black; border-style: dashed;">
                    ...
                    <div>
                        <div style="display: flex; flex-direction: row; width: 95%; margin: 0 auto;">
                            <div class="" style="width: 50%;">
                                {{-- <div style="width: 99%; border: 1px solid black;">Psychomotor</div> --}}
                                <div style="width: 99%;">
                ...
                <div style="width: 95%; display: flex; flex-direction: row; margin: 0 auto;">
                    <div class="" style="width: 50%; height: 50px; display: flex; flex-direction: column;">
                        ...
                        <i style="font-size: 13px; font-style: normal;">Principal/Head Teacher Signature</i></i>
