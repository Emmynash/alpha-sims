...
@endif
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Add Form Master</h1>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Add Form Master</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid" id="addformmasterroot">
  ...
  <script src="{{ asset('js/appformmaster.js?v=1') }}"></script>

  <script>
    function scrollocation(){
      document.getElementById('teachersmain').className = "nav-link active"
      document.getElementById('formmasteroptionadd').className = "nav-link active"
    }
</script>
