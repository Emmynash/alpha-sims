    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          ...
          <button type="button" class="btn btn-sm btn-info" data-toggle="popover-hover" title="Mark Manage" data-content="On this module, you are required to enter subject scores for each class.">Need help?</button>
        </div><!-- /.col -->
        <div class="col-sm-6">
  ...
  <section class="content">
    <div class="container-fluid">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <select name="selected_class" id="classselect" class="form-control form-control-sm">
                  ...
                  @if (count($arrayOfClassesMain) > 0)
                  @foreach ($arrayOfClassesMain as $classes)
      ...
      <div id="notificationalertmarks" style="display: none;" class="alert alert-info">
        <strong>Note</strong> Click on the process button only when you are done inputting all student marks for all subject.<br>
        <strong>Important</strong> To ensure results are generated with accuracy, all student results should be inputted
