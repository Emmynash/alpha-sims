    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          ...
          <button type="button" class="btn btn-sm btn-info" data-toggle="popover-hover" title="Form Teacher" data-content="Form teachers can manage there students subject record and ensure all data for each record has been entered before result is generated.">Need help?</button>
...
{{-- <div class="container">
              <div class="alert alert-info alert-dismissible">
                ...
                <strong>Info!</strong> If you're certain all students record has been updated, kindly notify the admin via the button below
              </div>
    ...
    <table class="table table-hover text-nowrap">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#edit_Student{{ $item->id }}" data-placement="top" title="Student details">
              <i class=" fas fa-user-edit"></i>
            </button>
            <button class="btn btn-warning btn-sm" data-toggle="modal" data-target="#comment_Student{{ $item->id }}" data-placement="top" title="Update Comment">
              <i class="fas fa-comments"></i>
            </button>
            @if (in_array($item->id, $commentRecordedArray))
            <button class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="Comment updated">
              <i class="fas fa-check"></i>
            </button>
            @else
            <button class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="top" title="Comment not set">
              <i class="fas fa-exclamation-circle"></i>
            </button>
            @endif

            <button class="btn btn-warning btn-sm" data-toggle="modal" data-target="#elective_Student{{ $item->id }}" data-placement="top" title="Show electives">
