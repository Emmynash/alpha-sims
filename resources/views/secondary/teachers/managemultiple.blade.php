      ...
      <div class="row mb-2">
        <div class="col-sm-6">
          ...
          {{-- <button type="button" class="btn btn-sm btn-info" data-toggle="popover-hover" title="Addsubjects"
                data-content="I this module, you are required to enter all subjects offered by your school according to the classes you have.">Need help?</button> --}}
    ...
    <div class="container-fluid" id="addteachersroot">
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-3">
          <a href="{{ route('form_teacher', ['classid' => $item->class_id, 'sectionid'=> $item->form_id]) }}">
