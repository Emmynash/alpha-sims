...
@endif
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Asign Electives</h1>
    ...
    <section class="content">
      <div class="container-fluid" id="addelectivesmainroot">
  ...
  <script src="{{ asset('js/appelective.js') }}"></script>

  <script>
    function scrollocation(){
      // document.getElementById('subjectsmain').className = "nav-link active"
      document.getElementById('formmasteroptionelective').className = "nav-link active"
    }
</script>
