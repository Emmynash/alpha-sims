                            ...
                            console.log(data)
                                ...
                                if (data.data) {
                                    ...
                                    if (data.data.data.length >0) {
                                        ...
                                        html += "<div class='col-md-2' style='margin-bottom: 30px;'><div class='card' style='height: 200px; margin-bottom:5px; display: flex; flex-direction: column;'>"+"<div class='text-center' style='height: 70%;'><img src='https://www.mswordcoverpages.com/wp-content/uploads/2018/10/Book-cover-page-3-CRC.png' alt='' width='auto' height='100%'></div>"+"<div class='default-color-dark' style='height: 30%;'><div class='text-center' style='display: flex; flex-direction: column;''>"+"<i class='text-white' style='font-style: normal; font-size: 10px;'>"+element.booktitle+"</i>"+"<h5 class='cat_text'><i class='text-white' style='font-style: normal; font-size: 10px;'>"+element.categoryname+"</i></h5>"+"</div></div>"+"<div class='default-color-dark' style='display: flex; align-items: center; justify-content: center; margin-bottom: -5px;'><button onclick=\"detailsModal('"+element.booktitle+"', '"+idforabouttext+"', '"+element.bookauthor+"', '"+element.categoryname+"', '"+element.id+"', '"+element.file+"', '"+element.bookisbn+"', '"+element.datebook+"', '"+element.booktype+"', '"+element.fileebook+"')\" style='padding: 5px; font-size: 9px;' class='btn btn-sm btn-info'><i class='fas fa-eye'></i> Details</button><textarea id='"+idforabouttext+"' style='display: none;'>"+element.aboutbook+"</textarea></div>"+"</div></div>";
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <i style="font-size: 10px;">Book Cover (Optional)</i>
