...
<div class="content-wrapper">
    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          ...
          <button type="button" class="btn btn-sm btn-info" data-toggle="popover-hover" title="Manage Staff" data-content="On this module, you are required to allocate roles to different Staff in your school.">Need help?</button>
        </div><!-- /.col -->
        <div class="col-sm-6">
  ...
  <section class="content">
    <div class="container-fluid">
      ...
      <!-- Central Modal Small -->
      <div class="modal fade" id="addrolequery" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<script>
  function scrollocation() {
    ...
    document.getElementById('addStaff').className = "nav-link active"
  }
</script>
