            ...
            <div class="page-break">
                        ...
                        <div class="col-md-2">
                            <div style="margin:0 auto;">
                                <div id="imagelogo"
                                    ...
                                    <img src="{{ asset('storage/schimages/' . $addschool->schoolLogo) }}" alt=""
                        ...
                        <div class="col-md-10">
                            <div style="margin:0 auto;">
                                ...
                                <div
                                    ...
                                    <i
                                        style="font-size: 40px; font-style: normal; font-family: Times New Roman, Times, serif; font-weight: bold;">{{ $addschool->schoolname }}</i>
                                    <i
                                        style="font-size: 20px; font-style: normal; font-family: Times New Roman, Times, serif; font-weight: bold;">{{ $addschool->schooladdress }},
                                        {{ $addschool->mobilenumber }}</i>
                                    <i
                                        style="font-size: 20px; font-style: normal; font-family: Times New Roman, Times, serif; font-weight: bold;"></i>
                                    <div>
                                        <i
                                            style="font-size: 20px; font-style: normal; font-family: Times New Roman, Times, serif; font-weight: bold;">Termly
                                            Report</i>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div style="width: 95%; margin:0 auto;">
                                <div data-toggle="collapse" data-target="#honourorpricesremark"
                                    style="width: 100%; margin: 0 auto; border-bottom: 1px solid black; font-size: 17px;">
                                    Name of Pupil: <i style="font-style: normal;"
                                        id="honourorpricesremarkmain">{{ $item->getStudentName->firstname }}
                                        {{ $item->getStudentName->middlename }}
                                        {{ $item->getStudentName->lastname }}</i>
                                </div>
                                <div style="height: 7px;"></div>
                                <div data-toggle="collapse" data-target="#honourorpricesremark"
                                    style="width: 100%; margin: 0 auto; border-bottom: 1px solid black; font-size: 17px;">
                                    Class: <i style="font-style: normal;"
                                        id="honourorpricesremarkmain">{{ $item->getClassName->classname }}
                                        {{ $item->getSectionName->sectionname }}</i>
                                </div>
                                <div style="height: 7px;"></div>
                                <div data-toggle="collapse" data-target="#honourorpricesremark"
                                    style="width: 100%; margin: 0 auto; border-bottom: 1px solid black; font-size: 17px;">
                                    Next Term Resumes: <i style="font-style: normal;" id="honourorpricesremarkmain">
                                        @if ($term == 1)
                                            <i
                                                style="font-style: normal; font-weight: bold;">{{ $addschool->secondtermstarts }}</i>
                                        @elseif ($term == 2)
                                            <i
                                                style="font-style: normal; font-weight: bold;">{{ $addschool->thirdtermstarts }}</i>
                                        @elseif ($term == 3)
                                            <i
                                                style="font-style: normal; font-weight: bold;">{{ $addschool->firsttermstarts }}</i>
                                        @else
                                ...
                                <div data-toggle="collapse" data-target="#honourorpricesremark"
                                    style="width: 100%; margin: 0 auto; border-bottom: 1px solid black; font-size: 17px;">
                                    Sex: <i style="font-style: normal;"
                                        id="honourorpricesremarkmain">{{ $item->gender }}</i>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div style="width: 95%; margin:0 auto;">
                                ...
                                <div data-toggle="collapse" data-target="#honourorpricesremark"
                                    style="width: 100%; margin: 0 auto; border-bottom: 1px solid black; font-size: 17px;">
                                    Admission No: <i style="font-style: normal;"
                                        id="honourorpricesremarkmain">{{ $item->admission_no }}</i>
                                </div>
                                <div style="height: 7px;"></div>
                                <div data-toggle="collapse" data-target="#honourorpricesremark"
                                    style="width: 100%; margin: 0 auto; border-bottom: 1px solid black; font-size: 17px;">
                                ...
                                <div data-toggle="collapse" data-target="#honourorpricesremark"
                                    style="width: 100%; margin: 0 auto; border-bottom: 1px solid black; font-size: 17px;">
                                    Session: <i style="font-style: normal;"
                                        id="honourorpricesremarkmain">{{ $schoolsession }}</i>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container-fluid">
                    <div style="display: flex; align-items: center; justify-content: center; height: 10px;">
                        <i style="text-decoration: underline; font-style: normal; font-weight: bold;">ACADEMIC
                            RECORDS</i>
                    </div>
                </div>
                ...
                <div class="container-fluid">
                    <table style="width: 100%; margin: 0 auto;" id="category">
                        <thead style="text-align: center;">
                            <tr>
                                <th style="font-size: 15px;">SUBJECTS</th>
                                ...
                                <th class="text-center  thdesign"><i class=""
                                        style="margin: 0px; padding: 5px; font-size: 17px;">First CA</i></th>
                                <th class="text-center  thdesign"><i class=""
                                        style="margin: 0px; padding: 5px; font-size: 17px;">Second CA</i></th>
                                <th class="text-center  thdesign"><i class=""
                                        style="margin: 0px; padding: 5px; font-size: 17px;">EXAM SCORE</i></th>
                                <th class="text-center  thdesign"><i class=""
                                        style="margin: 0px; padding: 5px; font-size: 17px;">TOTAL MARK</i></th>
                                {{-- <th class="text-center  thdesign"><i style="writing-mode: vertical-lr; margin: 0px; padding: 5px;">Points</i></th> --}}
                                <th class="text-center  thdesign"><i class=""
                                        style=" margin: 0px; padding: 5px; font-size: 17px;">Average</i></th>
                                {{-- <th class="text-center  thdesign"><i class="" style=" margin: 0px; padding: 5px; font-size: 17px;">POSITION</i></th> --}}
                                <th class="text-center  thdesign"><i class=""
                                        style="margin: 0px; padding: 5px; font-size: 17px;">Grade</i></th>
                        ...
                        <tbody id="resultprinttable">
                            ...
                            @foreach ($addschool->getSubjectList($item->id, $schoolsession, $classid, $section, $term) as $subjects)
                                <tr style='font-size: 17px;'>
                                    <td class='text-center thdesign' style='font-size: 17px;'>
                                        <center>{{ $subjects->subjectname }}</center>
                                    </td>
                                    @if ($addschool->caset == 1)
                                        <td class='text-center thdesign' style='font-size: 17px;'>
                                            <center>
                                                {{ $addschool->getSubjectMark($item->id, $subjects->id, $schoolsession) == null? '0': $subjects->getSubjectMark($item->id, $subjects->id, $schoolsession)->ca3 }}
                                            </center>
                                        </td>
                                    @endif
                                    <td class='text-center thdesign' style='font-size: 17px;'>
                                        <center>
                                            {{ $addschool->getSubjectMark($item->id, $subjects->id, $schoolsession) == null? '0': $addschool->getSubjectMark($item->id, $subjects->id, $schoolsession)->ca2 }}
                                        </center>
                                    </td>
                                    <td class='text-center thdesign' style='font-size: 17px;'>
                                        <center>
                                            {{ $addschool->getSubjectMark($item->id, $subjects->id, $schoolsession) == null? '0': $addschool->getSubjectMark($item->id, $subjects->id, $schoolsession)->ca1 }}
                                        </center>
                                    </td>
                                    <td class='text-center thdesign' style='font-size: 17px;'>
                                        <center>
                                            {{ $addschool->getSubjectMark($item->id, $subjects->id, $schoolsession) == null? '0': $addschool->getSubjectMark($item->id, $subjects->id, $schoolsession)->exams }}
                                        </center>
                                    </td>
                                    <td class='text-center thdesign' style='font-size: 17px;'>
                                        <center>
                                            {{ $addschool->getSubjectMark($item->id, $subjects->id, $schoolsession) == null? '0': $addschool->getSubjectMark($item->id, $subjects->id, $schoolsession)->totalmarks }}
                                        </center>
                                    </td>
                                    ...
                                    <td class='text-center thdesign' style='font-size: 17px;'>
                                        <center>
                                            {{ $addschool->getClassAverageMarkSubject($subjects->id, $term, $schoolsession) == null? '0': round($addschool->getClassAverageMarkSubject($subjects->id, $term, $schoolsession)->average, 1) }}
                                        </center>
                                    </td>
                                    ...
                                    <td class='text-center thdesign' style='font-size: 17px;'>
                                        <center>
                                            {{ $addschool->getSubjectMark($item->id, $subjects->id, $schoolsession) == null? '0': $addschool->getSubjectMark($item->id, $subjects->id, $schoolsession)->grades }}
                                        </center>
                                    </td>
                ...
                <div style="container-fluid">
                    <i style="margin: 10px 0px 0px 50px; font-style: normal; font-size: 17px;">Exam Total: <i id="sum1"
                            style="margin: 10px 0px 0px 5px; font-style: normal; font-size: 17px;">{{ round(empty($addschool->getResultAverage($item->id, $classid, $term, $schoolsession))? 'NAN': $addschool->getResultAverage($item->id, $classid, $term, $schoolsession)->sumofmarks,2) }}</i></i>
                    ...
                    <div class="text-center" style="width: 95%; margin: 10px auto;">
                        @if ($addschool->getGradeDetails($addschool->id, $classtype)->count() > 0)
                            @foreach ($addschool->getGradeDetails($addschool->id, $classtype) as $itemgrade)
                                <i style="font-size: 17px; font-style: normal;">{{ $itemgrade->gpaname }} =
                                    ({{ $itemgrade->marksfrom }}-{{ $itemgrade->marksto }})</i>
                            @endforeach
                        @endif
                    </div>
                </center>
                        ...
                        <div class="" style="">
                            ...
                            <div style="width: 99%;">
                                <table style="width: 100%">
                                    <thead>
                                        <tr>
                                            <th style="font-size: 17px; width: 50%;">BEHAVIOUR AND ACTIVITIES</th>
                                    ...
                                    <tbody>
                                        ...
                                        @if ($motolistbeha->count() > 0)
                                            @foreach ($motolistbeha as $itemmoto)
                                                <tr>
                                                    <td class="thdesign1"><i
                                                            style="padding-left: 10px; font-style: normal;">{{ $itemmoto->name }}</i>
                                                    </td>
                                                    <td id="punctuation" class="thdesign1">
                                                        {{ $itemmoto->getmotoscore($itemmoto->id, $item->id, $schoolsession, $term) }}
                                                    </td>
                                                </tr>
                                            @endforeach
                                        @endif
                    ...
                    <div class="" style="">
                        <div style="width: 99%;">
                            <table style="width: 100%">
                                <thead>
                                    <tr>
                                        <th style="font-size: 17px; width: 50%; font-size: 17px;">SKILLS</th>
                                        <th class="text-center  thdesign1" style="font-size: 17px;">Marks(1-5)</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    @if ($motolistskills->count() > 0)
                                        @foreach ($motolistskills as $itemskills)
                                            <tr>
                                                <td class="thdesign1" style="font-size: 17px;">
                                                    {{ $itemskills->name }}</td>
                                                <td id="punctuation" class="thdesign1" style="font-size: 17px;">
                                                    {{ $itemskills->getmotoscore($itemskills->id, $item->id, $schoolsession, $term) }}
                                                </td>
                                            </tr>
                                        @endforeach
                                    @endif
                ...
                <div class="container-fluid">
                    <div data-toggle="collapse" data-target="#honourorpricesremark"
                        ...
                        <i style="font-size: 17px; font-style: normal;" id="honourorpricesremarkmain">
                ...
                <div class="container-fluid">
                    <div style="width: 100%; display: flex; flex-direction: row; margin: 0 auto;">
                        <div class=""
                            style="width: 50%; height: 50px; display: flex; flex-direction: row; align-items: center;">
                            ...
                            <img src="https://drive.google.com/uc?id=1M5pwqpSuBxks7YBe9h-D_3vgJ98zVABG" alt=""
                                height="90px">
