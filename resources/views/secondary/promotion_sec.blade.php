    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          ...
          <button type="button" class="btn btn-sm btn-info" data-toggle="popover-hover" title="Students Promotion" data-content="This is where students are promoted. Note: a session change is required to promote students.">Need help?</button>
        </div><!-- /.col -->
        <div class="col-sm-6">
  ...
  <section class="content">
    <div class="container-fluid">
      ...
      <div class="alert alert-info" role="alert">
        It seems you haven't set your school session. Please do as it is a requirement for promoting student. Do it now? <a href="/setupschool_sec">Yes</a>
      </div>
      @endif
      ...
      <div id="jss3toss1promo" style="display: none;" class="alert alert-info" role="alert">
        ...
        set that. For that reason, promotion from junior to senior secondary
