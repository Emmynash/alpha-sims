	...
	<body id="bg">
					...
					<div class="row">
						<div class="col-lg-8 col-12">
							...
							<div class="top-contact"> 
								<div class="single-contact"><i class="fa fa-phone"></i>Phone: +2349077357915</div> 
								<div class="single-contact"><i class="fa fa-envelope-open"></i>Email: connect2alphasims@gmail.com</div>	
								<div class="single-contact"><i class="fa fa-clock-o"></i>24/7</div> 
							</div>
							<!-- End Top Contact -->
						</div>	
						<div class="col-lg-4 col-12">
							<div class="topbar-right">
								...
								<ul class="social-icons">
									<li><a href="https://www.facebook.com/ALPHA-SIMS-106616094387558/"><i class="fa fa-facebook"></i></a></li>
									<li><a href="#"><i class="fa fa-twitter"></i></a></li>
									<li><a href="#"><i class="fa fa-linkedin"></i></a></li>
									<li><a href="#"><i class="fa fa-dribbble"></i></a></li>
								</ul>															
								<div class="button">
									<a href="/register" class="bizwheel-btn">Get Started</a>
								</div>
							</div>
						</div>
					</div>
		...
		<section class="hero-slider style1">
			<div class="home-slider">
				<!-- Single Slider -->
				<div class="single-slider" style="background-image:url('images/pic2.jpg')">
					<div class="container">
						<div class="row">
							<div class="col-lg-7 col-md-8 col-12">
								<div class="welcome-text"> 
									<div class="hero-text"> 
										<h4>Have the best educational experience ever!</h4>
										<h1 class="text-white">Alpha-sims School Management System</h1>
										<div class="p-text">
											<p>With numrous of activities at your fingertips, your school‘s next inspiring experience is just a tap away.</p>
										</div>
										<div class="button">
											<a href="/login" class="bizwheel-btn theme-1 effect">Login</a>
				...
				<!--/ End Single Slider -->
				<!-- Single Slider -->
				<div class="single-slider" style="background-image:url('images/pic1.jpg')">
					<div class="container">
						<div class="row">
							<div class="col-lg-7 col-md-8 col-12">
								<div class="welcome-text"> 
				...
				<div class="row">
					<div class="col-lg-3 col-md-6 col-12">
						...
						<div class="single-feature">
							...
							<h4><a href="service-single.html">E-LEARNING</a></h4>
							<p>Learning never stops! Children can learn from home or anywhere via our video conferencing app.</p>
							<div class="button">
					...
					<div class="col-lg-3 col-md-6 col-12">
						...
						<div class="single-feature">
							<div class="icon-head"><i class="fa fa-podcast"></i></div>
							<h4><a href="service-single.html">FINANCE</a></h4>
							<p>Track fees payment from anywhere. The system automates the process of fees payment, income and expenses, generates receipts for payments hence easing tedious book and record keeping process.</p>
							<div class="button">
								<a href="#" class="bizwheel-btn"><i class="fa fa-arrow-circle-o-right"></i>Learn More</a>
							</div>
						</div>
					...
					<div class="col-lg-3 col-md-6 col-12">
						...
						<div class="single-feature active">
							<div class="icon-head"><i class="fa fa-podcast"></i></div>
							<h4><a href="service-single.html">RESULT</a></h4>
							<p>Say no to error prone results and save resources used in printing hard copy result sheets. Teachers can increase their efficiency and timeliness in compiling result by using the automated system.
								Parents can view their children’s results online and download through their smart phone.</p>
							<div class="button">
					...
					<div class="col-lg-3 col-md-6 col-12">
						...
						<div class="single-feature">
							<div class="icon-head"><i class="fa fa-podcast"></i></div>
							<h4><a href="service-single.html">TEACHER</a></h4>
							<p>Access students’ information without having to regularly see the school administrator, school owner or head teacher.</p>
							<div class="button">
								<a href="service-single.html" class="bizwheel-btn"><i class="fa fa-arrow-circle-o-right"></i>Learn More</a>
							</div>
						</div>
				...
				<div class="row">
					<div class="col-lg-9 col-12">
						<div class="call-inner">
							<h2>Try ALPHA-SIMS and see for yourself</h2>
							<p>Our package has all-in-one solution. </p>
						</div>
					</div>
							...
							<div id="portfolio-item" class="portfolio-item-active">
								<div class="cbp-item business animation">
									...
									<div class="single-portfolio">
										...
										<div class="portfolio-content">
											<h4><a href="portfolio-single.html">Finance</a></h4>
								...
								<div class="cbp-item seo consulting">
									...
									<div class="single-portfolio">
										...
										<div class="portfolio-content">
											<h4><a href="portfolio-single.html">Result processing</a></h4>
											{{-- <p>Seo, Consulting</p> --}}
										</div>
									</div>
									<!--/ End Single Portfolio -->
								...
								<div class="cbp-item marketing seo">
									...
									<div class="single-portfolio">
										...
										<div class="portfolio-content">
											<h4><a href="portfolio-single.html">E-Learning</a></h4>
											{{-- <p>Marketing, SEO</p> --}}
										</div>
									</div>
									<!--/ End Single Portfolio -->
						...
						<div class="col-lg-3 col-md-6 col-12">
							...
							<div class="single-widget footer-about widget">	
								...
								<div class="footer-widget-about-description">
									<p>ALPHA-SIMS has every feature your school will ever need....</p>
								</div>	
								<div class="social">
									<!-- Social Icons -->
									<ul class="social-icons">
										<li><a class="facebook" href="https://www.facebook.com/ALPHA-SIMS-106616094387558/" target="_blank"><i class="fa fa-facebook"></i></a></li>
						...
						<div class="col-lg-4 col-md-6 col-12">	
							...
							<div class="single-widget footer_contact widget">	
								...
								<ul class="address-widget-list">
									<li class="footer-mobile-number"><i class="fa fa-phone"></i>+2349077357915</li>
									<li class="footer-mobile-number"><i class="fa fa-envelope"></i>connect2alphasims@gmail.com</li>
									<li class="footer-mobile-number"><i class="fa fa-map-marker"></i>First floor, Kalwa house, zaramangada roundabout, Jos</li>
								</ul>
							</div>		
							<!--/ End Footer Contact -->						
						</div>
					...
					<div class="row">
						<div class="col-12">
							<div class="copyright-content">
								<!-- Copyright Text -->
								<p>© Copyright <a href="https://www.bluealgorithmtechnologies.com">ALPHA-SIMS</a>. Design &amp; Development By <a target="_blank" href="#">Blue Algorithm Technologies Limited</a></p>
							</div>
						</div>
					</div>
				</div>
		...
		<!-- Cube Portfolio JS -->
		<script src="{{ asset('landing') }}/js/cubeportfolio.min.js"></script>
		<!-- Slick Nav JS -->
