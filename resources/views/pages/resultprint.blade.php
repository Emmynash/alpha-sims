        ...
        $(document).ready(function(){
            $(function() {
                ...
                $.ajaxSetup({
                    ...
                    $.ajax({
                        url:"/querystudentforresult", //the page containing php script
                        ...
                        success:function(result){
                            ...
                            if (result.resultdetails) {
                                ...
                                var classname = result.fetchUserDetails[0].classnamee;
                                ...
                                var classcount = result.fetchUserDetails[0].studentcount;

                                var creativityresult = result.psycomoto[0].creativity;
                                var reliabilityresult = result.psycomoto[0].reliability;
                                var politenessresult = result.psycomoto[0].politeness;
                                var gamesportmoto = result.psycomoto[0].gamessport;
                                var handlingoftoolsmoto = result.psycomoto[0].handlingoftools;
                                var honestymoto = result.psycomoto[0].honesty;
                                var neatness = result.psycomoto[0].neatness;
                                var punctuation = result.psycomoto[0].punctuality;
                                var selfcontrolmoto = result.psycomoto[0].selfcontrol;
                                

                                var studentposition = result.positionaverage[0].position;
                                
                                document.getElementById('classcountmain').innerHTML = classcount;

                                document.getElementById('studentposition').innerHTML = studentposition

                                document.getElementById('creativityresult').innerHTML = creativityresult;
                                document.getElementById('reliabilityresult').innerHTML = reliabilityresult;
                                document.getElementById('politenessresult').innerHTML = politenessresult;
...
<body>
    <div class="card" style="height: 50px; display: flex; align-items: center; justify-content: center; position: fixed; top: 0; left: 0; right: 0; border-radius: 0px; z-index: 999;">
        <div style="display: flex; flex-direction: row;">
            <a href="/result"><button class="btn btn-sm btn-danger" id="btnPrintback" style="margin-right: 10px;">Back</button></a>
        ...
        <div id="printJS-form" class="" style="width: 793px; height: 1123px; margin: 0 auto;">
            <div style="width: 793px; height: 1123px; border: 2px solid black; border-style: dashed;">
                    ...
                    <div style="width: 50%;">
                        <div class="" style="width: 95%; display: flex; flex-direction: column; margin: 0 auto;">
                            <table>
                                ...
                                <tr>
                                    <td><i style="font-size: 12px; font-style: normal;">Term Ending:</i></td>
                                    <td></td>
                                </tr>
                                <tr>
                    ...
                    <div style="width: 50%;">
                        <div style="width: 95%; display: flex; flex-direction: column; margin: 0 auto;">
                            <table>
                                ...
                                <tr>
                                    <td><i style="font-size: 12px; font-style: normal;">Next Term Begins:</i></td>
                                    <td><i id="resultterm" style="font-size: 12px; font-style: normal; font-weight: bold;"></i></td>
                                </tr>
                                <tr>
                                ...
                                <div style="width: 99%;">
                                    <table style="width: 100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="thdesign1">Creativity</td>
                                                <td id="creativityresult" class="thdesign1"></td>
                                            </tr>
                                            <tr>
                                                <td class="thdesign1">Politeness</td>
                                                <td id="politenessresult" class="thdesign1"></td>
                                            </tr>
                                            <tr>
                                                <td class="thdesign1">Reliability</td>
                                                <td id="reliabilityresult" class="thdesign1"></td>
                                            </tr>
                                            <tr>
                            ...
                            <div class="" style="width: 50%;">
                                <div style="width: 99%;">
                                    <table style="width: 100%;">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="thdesign1">A</td>
                                                <td class="thdesign1">Excellent</td>
                                            </tr>
                                            <tr>
                                                <td class="thdesign1">B</td>
                                                <td class="thdesign1">V.Good</td>
                                            </tr>
                                            <tr>
                                                <td class="thdesign1">C</td>
                                                <td class="thdesign1">Good</td>
                                            </tr>
                                            <tr>
                                                <td class="thdesign1">D</td>
                                                <td class="thdesign1">pass</td>
                                            </tr>
                                            <tr>
                                                <td class="thdesign1">E</td>
                                                <td class="thdesign1">poor</td>
                                            </tr>
                                            <tr>
                                                <td class="thdesign1">F</td>
                                                <td class="thdesign1">poor</td>
                                            </tr>
                                        </tbody>
                                    </table>
                ...
                <div style="width: 95%; display: flex; flex-direction: row; margin: 0 auto;">
                    <div class="" style="width: 50%; display: flex; flex-direction: column; margin: 0 auto;">
                        <i style="font-size: 10px; font-style: normal;">Total Mark: <i style="font-size: 10px; font-style: normal; font-weight: bold;">590</i></i>
                        <i style="font-size: 10px; font-style: normal;">Class Count: <i id="classcountmain" style="font-size: 10px; font-style: normal; font-weight: bold;">590</i></i>
                    </div>
                    <div class="" style="width:50%;">
                        <i style="font-size: 10px; font-style: normal;">Average Mark: <i style="font-size: 10px; font-style: normal; font-weight: bold;">45</i></i>
                    </div>
                </div>
                <br>
                <div style="width: 95%; display: flex; flex-direction: row; margin: 0 auto;">
                    <div class="" style="width: 50%;">
                        <i style="font-size: 13px; font-style: normal;">Principal Signature's<i>_________________________________</i></i>
