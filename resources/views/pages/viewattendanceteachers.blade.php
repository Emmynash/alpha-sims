  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">View Teachers Attendance</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <form id="addschool" method="POST" action="/shoolreg" enctype="multipart/form-data">
                    ...
                    <div id="formdivtwo">
                        <div class="form-group">
                            <input id="sessionquery" name="sessionquery" style="border: none; background-color:#EEF0F0;" class="form-control form-control-lg" value="2012/2013" type="text" placeholder="Session">
                        </div>
                        <div class="form-group">
            ...
            <!-- /.row -->
            <button id="" type="button" onclick="getstudentList()" class="btn btn-info" form="addschool">Get list</button>
...
// -------------------------------------------------------------------------------------
    ...
    var datecheck = /^[0-9-]+$/; 
      ...
      headers: {
        ...
        $.ajax({
          url:"/viewatteachers", //the page containing php script
          method: "POST", //request type,
          cache: false,
          ...
          success:function(result){
              ...
              for (let index = 0; index < result[0].length; index++) {
                ...
                if (n) {
                    ...
                    $('#studenttable').find('tbody').append('<tr><td>'+ result[0][index]['id'] +'</td><td>'+ result[0][index]['firstname'] + ' ' + result[0][index]['middlename'] + ' ' + result[0][index]['lastname'] +'</td><td>'+ result[0][index]['classname'] +'</td><td>'+ result[0][index]['section'] +'</td><td>dsdsdsd</td><td><button class="btn"><i style="color: red;" class="fas fa-times"></i></button></td></tr>');
                }
              }
         },
         error:function(){
...
// ----------------------------------------------------------------------------------------
   ...
   function scrollocation(){
        ...
        document.getElementById('viewteacherattendanceaside').className = "nav-link active"
    }
</script>
