          ...
          <div class="col-12">
            <div class="card">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <div class="row">
                              ...
                              <div class="col-md-6">
                                <label for="">Principal's/Head Teacher's Signature</label>
                                <div class="image">
                            ...
                            <div class="row">
                              <div class="col-md-6">
                                ...
                                <label for="">School Name: {{$schools->schoolname}}</label>
              ...
              <td>
                ...
                <button class="btn btn-danger btn-sm" data-toggle="tooltip" title="Delete School"><i class="far fa-trash-alt"></i></button>
              </td>
              </tr>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button type="submit" form="asignroleform" class="btn btn-success btn-sm">Assign Role</button>
...
<footer class="main-footer">
  <strong>Copyright &copy; 2019-2022 <a href="http://bluealgorithmtechnologies.com">Blue Algorithm technologies.</a>.</strong>
  All rights reserved.
