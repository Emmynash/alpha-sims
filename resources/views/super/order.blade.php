                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <!-- Central Modal Small -->
                      <div class="modal fade" id="deleteschool{{$schools->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                      ...
                      <td>
                        ...
                        <button class="btn btn-danger btn-sm" data-toggle="modal" title="Delete School" data-target="#deleteschool{{$schools->id}}"><i class="far fa-trash-alt"></i></button>
                      </td>
                    </tr>
