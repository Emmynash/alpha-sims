...
<body>
    ...
    <div>
        <div class="btn-group" role="group" aria-label="Basic example">
            <a href="#faq"><button type="button" class="btn btn-outline-mdb-color waves-effect"><i class="fas fa-question-circle fa-sm pr-2" aria-hidden="true"></i> FAQ</button></a>
            ...
            <div class="card">
                ...
                <div style="margin: 20px;">
                    <p class="">To keep students connected and always learning anytime and anywhere,
                        ...
                        knowledge outside of a traditional classroom. it in most cases
                        refer to programs delivered online.
                        Alpha-Sims provide a conducive environment for learning outside a class.
                        Teacher and student interact on the secured platform . in addition,
                ...
                <div style="margin: 20px;">
                    <p class="">
                        ...
                        Imagine computing results for a lot of student at a time, error will always
                ...
                <div style="margin: 20px;">
                    <p class="">
                        ...
                        With alpha-sims no more tedious admission processes.
                    </p>
                </div>
                ...
                <div style="margin: 20px;">
                    <p class="">
                        Availability of information is of paramount importance in every stage of education and for that reason,
                        making books easily accessible to students is key to a progressive growth. Searching for books in
                        shelves and documenting book rentals is a lot of work. To help keep knowledge sharing organized and trackable,
        ...
        <div class="accordion md-accordion accordion-3 z-depth-1-half" id="accordionEx194" role="tablist" aria-multiselectable="true">
                ...
                <div id="collapse4" class="collapse show" role="tabpanel" aria-labelledby="heading4" data-parent="#accordionEx194">
                    <div class="card-body pt-0">
                        <p>Alpha-Sims is a School Management System that provides all key features required for the effective
                            ...
                            you all the features you may need.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-header" role="tab" id="heading5">
                    <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx194" href="#collapse5" aria-expanded="false" aria-controls="collapse5">
                        <h3 class="mb-0 default-color-dark-text">
            ...
            <div class="card">
                ...
                <div class="card-header" role="tab" id="heading7">
                    <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx194" href="#collapse7" aria-expanded="false" aria-controls="collapse6">
                        <h3 class="mb-0 default-color-dark-text">
                ...
                <div id="collapse7" class="collapse" role="tabpanel" aria-labelledby="heading7" data-parent="#accordionEx194">
                    <div class="card-body pt-0">
                        ...
                        <p style="margin: 0px;">
                            If you are a school and after successful registration, head to add Institution and
                            submit and application filling the appropriate fields and selecting a school type.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <!-- Card header -->
                <div class="card-header" role="tab" id="heading7">
                    <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx194" href="#collapse8" aria-expanded="false" aria-controls="collapse6">
                        <h3 class="mb-0 default-color-dark-text">
                ...
                <div id="collapse8" class="collapse" role="tabpanel" aria-labelledby="heading7" data-parent="#accordionEx194">
                    <div class="card-body pt-0">
                        <p>We have implemented multiple layers of security to ensure your data are safe and secure.
                            Unauthorized individuals cannot gain access to them
                        </p>
                    </div>
                </div>
            </div>
