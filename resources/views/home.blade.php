            ...
            <div class="tab-content">
                ...
                <div id="home" class="container tab-pane active"><br>
                    <div class="alert alert-info alert-block">
                        ...
                        <strong>Your registration was successful but is yet to be approved. Submit your system number to your
                            school admin in order to approve your registration. Afterwards, refresh this page to see your dashboard
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div>
                                <i>You need to upload your profile pic before printing slip</i>
                                <br>
                ...
                <form id="schoolregform" action="/shoolreg" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <i style="font-style: normal;">Select School Type</i>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <input type="text" name="dateestablished" class="form-control @error('dateestablished') is-invalid @enderror" value="{{old('dateestablished')}}" placeholder="Date Established">
                            </div>
                            <div class="form-group">
                    ...
                    <i style="font-style: normal; font-size: 20px;">Image</i>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <i style="font-style: normal;">Principal/Head Teacher Signature (not more than 200kb)</i>
                ...
                <div class="alert alert-info alert-block">
                    ...
                    <strong>We have recieved your application to use our plateform Alpha-Sims to
                        boost excellence in your school. Your submission is under review, we will
