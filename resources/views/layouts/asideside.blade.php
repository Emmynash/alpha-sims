  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
      <!-- Brand Logo -->
      <div
          style="display: flex; flex-direction: column; justify-content: center; align-items: center; margin-top: 5px; border-bottom: 1px solid #fff;">
      ...
      <div class="sidebar">
              ...
              <div id="profileimgdiv" class="image">
                  ...
                  <div>
                      ...
                      <form id="pixupdatelater" action="javascript:console.log('submited')" method="POST">
                          @csrf
                          <input id="profilepix" name="profilepix" type="file"
                              style="visibility: hidden; position: absolute;" />
                      </form>
                      {{-- <button id="button">trigger file selection</button> --}}
                  </div>
                  <img id="profileimgmainpix"
                      src="{{ asset(Auth::user()->profileimg != null ? Auth::user()->profileimg : 'https://gravatar.com/avatar/?s=200&d=retro') }}"
                  ...
                  @if (Auth::user()->hasRole('HeadOfSchool') || Auth::user()->hasRole('Bursar'))
                      <li class="nav-item has-treeview">
                          ...
                          <ul class="nav nav-treeview"
                              style=" color: #90ada7; padding-left: 10px !important;  border-bottom: 1px solid #585858;  font-size: 14px;">
                              ...
                              @can('fee management')
                                  ...
                                  <li class="nav-item">
                                      <a id="studentdiscountlistscroll" href="{{ route('student_dicount') }}"
                                          class="nav-link">
                              ...
                              @can('can send or receive request')
                                  <li class="nav-item">
                                      <a id="requestlistscroll" href="{{ route('order_request') }}"
                                          class="nav-link">
                              ...
                              @can('student attendance')
                                  <li class="nav-item has-treeview">
                                      ...
                                      <ul class="nav nav-treeview"
                                          style=" color: #90ada7; padding-left: 10px !important;  border-bottom: 1px solid #585858;  font-size: 14px;">
                                          <li class="nav-item">
                                              <a id="addstudentattendanceaside" href="{{ route('studentattendance') }}"
                                                  class="nav-link">
                                          ...
                                          <li class="nav-item">
                                              <a id="viewstudentattendance" href="{{ route('viewallstudents') }}"
                                                  class="nav-link">
        ...
        <p>
          Edit Profile
                      ...
                      @can('form teacher')
                          <li class="nav-item has-treeview">
                              ...
                              <ul class="nav nav-treeview"
                                  ...
                                  @can('form teacher')
                                      <li class="nav-item">
                                          <a id="formmasteroption" href="{{ route('form_teacher_multiple') }}"
                                              class="nav-link">
                      ...
                      @can('form teacher')
                          <li class="nav-item">
                              <a id="formmasteroptionelective" href="{{ route('add_student_electives') }}"
                                  class="nav-link">
                              ...
                              @can('assign form teacher')
                                  <li class="nav-item has-treeview">
                                      ...
                                      <ul class="nav nav-treeview"
                                          style=" color: #90ada7; padding-left: 10px !important;  border-bottom: 1px solid #585858;  font-size: 14px;">
                                          <li class="nav-item">
                                              <a id="addteachersmain" href="{{ route('addteacher') }}"
                                                  class="nav-link">
                                                  <i class="nav-icon fas fa-plus"></i>
                                                  <p>Add New</p>
                                              </a>
                                          ...
                                          <li class="nav-item">
                                              <a id="formmasteroptionadd" href="/form_teacher_sec_index"
                                                  class="nav-link">
                                                  <i class="nav-icon fas fa-clipboard-list"></i>
                                                  <p>Form Teacher</p>
                                              </a>
                              ...
                              @can('take teachers attendance')
                                  <li class="nav-item has-treeview">
                                      ...
                                      <ul class="nav nav-treeview"
                                          style=" color: #90ada7; padding-left: 10px !important;  border-bottom: 1px solid #585858;  font-size: 14px;">
                                          <li class="nav-item">
                                              <a id="addteacherattendanceaside" href="{{ route('teachersattendance') }}"
                                                  class="nav-link">
                                                  <i class="nav-icon fas fa-plus"></i>
                                                  <p>Add</p>
                                              </a>
                                          ...
                                          <li class="nav-item">
                                              <a id="viewteacherattendanceaside" href="/viewallteachers"
                                                  class="nav-link">
                                                  <i class="nav-icon fas fa-clipboard-list"></i>
                                                  <p>View</p>
                                              </a>
                      ...
                      <li class="nav-item has-treeview">
                          ...
                          <ul class="nav nav-treeview"
                              ...
                              @can('view student result')
                                  <li class="nav-item">
                                      <a id="resultmaingenscroll" href="{{ route('result_by_class') }}"
                                          class="nav-link">
                              ...
                              @can('generate student result')
                                  <li class="nav-item">
                                      <a id="resultmaingenscrollgenerate" href="{{ route('generate_result') }}"
                                          class="nav-link">
