...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  <div>
    <div style="display: flex; flex-direction: column; justify-content: center; align-items: center; margin-top: 5px; border-bottom: 1px solid #fff;">
      <img src="{{asset('storage/schimages/'.$schooldata[0]['schoolLogo'])}}" alt="" class="brand-image img-circle elevation-3" style="opacity: .8" width="60px" height="60px">
                      ...
                      <div class="col-12">
                        ...
                        <div class="card-body table-responsive p-0">
                          <table class="table table-hover text-nowrap">
                            ...
                            <tbody>
                              @if (count($historySub) <1) {{-- <tr><td><p>No Record found</p></td></tr> --}} @else @foreach ($historySub as $historySubSingle) <tr>
                                <td>#</td>
