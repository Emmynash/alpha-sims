        ...
        try {
            ...
            if ($checksubjecttype->subjecttype == 2) {
                ...
                $studentlist = DB::table('addstudent_secs')
                    ...
                    ->where(['addstudent_secs.classid' => $classId, 'addstudent_secs.schoolsession' => $session, 'addstudent_secs.studentsection' => $studentsection])->orderBy('assessment_table_totals.position', 'ASC')->get();
                ...
                $studentlist = Addstudent_sec::join('users', 'users.id', '=', 'addstudent_secs.usernamesystem')
                    ...
                    ->where(['addstudent_secs.classid' => $classId, 'addstudent_secs.schoolsession' => $session, 'addstudent_secs.studentsection' => $studentsection])->orderBy('assessment_table_totals.totals', 'ASC')->get();
